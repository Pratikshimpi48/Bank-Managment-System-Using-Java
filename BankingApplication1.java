...
class Customer1 implements Serializable {
    ...
    public boolean login(String name, String password) {
        try {
            ...
            Customer1 o = readFromFile(new File("C:/Users/rahul/OneDrive/Desktop/DemoBank/Customer/" + name + ".txt"));
    ...
    public void ApplyforLoan(double loanamount, String username) {
        try {
            double balance;
            File oldfile = new File("C:/Users/rahul/OneDrive/Desktop/DemoBank/Customer/" + username + ".txt");
    ...
    public void UpdateDetail(String username, Scanner sc) {
        try {
            ...
            Customer1 b = readFromFile(
                    new File("C:/Users/rahul/OneDrive/Desktop/DemoBank/Customer/" + username + ".txt"));
            while (true) {
                if (num == 1) {
                    System.out.println("Enter the name you want to change");
                   
                    String name = Admin1.Name(sc);
                    b.setName(name);
                    System.out.println(Green + "\nUpdate Successfully........\n" + Reset);
                    b.writeToFile(new File("C:/Users/rahul/OneDrive/Desktop/DemoBank/Customer/" + username + ".txt"),
                            b);
                    break;
                } else if (num == 2) {
                    System.out.print("Enter the contact you want to change ");
                    
                    String contact = Admin1.Contact(sc);
    ...
    public void viewaccountdetail(String username) {
        try {
            ...
            o = o.readFromFile(new File("C:/Users/rahul/OneDrive/Desktop/DemoBank/Customer/" + username + ".txt"));
    ...
    public void Transfermoney(String username, Scanner sc) {
        try {
            File file = new File("C:/Users/rahul/OneDrive/Desktop/DemoBank/Customer/" + username + ".txt");
            if (file.exists()) {
                ...
                File file2 = new File("C:/Users/rahul/OneDrive/Desktop/DemoBank/Customer/" + username1 + ".txt");
                if (file2.exists()) {
    ...
    public void toTransactionFile(String username, String transaction, double amount) {
        try {
            File transFile = new File(
                    "C:/Users/rahul/OneDrive/Desktop/DemoBank/TransactionHistory/" + username + "Transfer.txt");
...
class Admin1 {
        ...
        while (flag) {
            ...
            for (int i = 0; i < ch.length; i++) {
                if (ch[i] == '0' || ch[i] == '1' || ch[i] == '2' || ch[i] == '3'
                        ...
                        || ch[i] == '7' || ch[i] == '8' || ch[i] == '9') {
                    flag = true;
                    System.out.println(Customer1.Red + "***You can't enter integer no.***" + Customer1.Reset);
                    break;
                } else {
                    flag = false;
                    continue;
            ...
            if (contact.length() == 10) {
                ...
                for (int i = 0; i < ch.length; i++) {
                    if (ch[i] == '0' || ch[i] == '1' || ch[i] == '2' || ch[i] == '3'
                        ...
                        System.out.println(
                                Customer1.Red + "***Please enter only number***" + Customer1.Reset);
                        flag5 = false;
                        break;
                    }
                }
                ...
                System.out.println(
                        Customer1.Red + "***Contact number must be equal 10 digit***" + Customer1.Reset);
                contact = sc.next();
            }
        }
        return contact;
    ...
    public void tocreateaccount(Customer1 obj) {
        try {
            ...
            System.out.println(Customer1.Green + "\nAccount Create Successfully......\n" + Customer1.Reset);
    ...
    public void viewaccountdetail(Scanner sc) {
        try {
            System.out.println("Enter customer's username");
        ...
        try {
            switch (choice) {
                case 1:
                    ...
                    File file = new File(
                            "C:/Users/rahul/OneDrive/Desktop/DemoBank/TransactionHistory/" + name + "Transfer.txt");
                ...
                case 2:
                    ...
                    System.out.println("");
                    f = new File("C:/Users/rahul/OneDrive/Desktop/DemoBank/Customer/" + name1 + ".txt");
                    Customer1 o = new Customer1();
                    o = o.readFromFile(f);
                    if (o.isBlocked()) {
                        o.setblock(false);
                ...
                case 3:
                    ...
                    f = new File("C:/Users/rahul/OneDrive/Desktop/DemoBank/Customer/" + name2 + ".txt");
                    c = c.readFromFile(f);
                    if (!c.isBlocked()) {
                        c.setblock(true);
                        c.writeToFile(f, c);
                        System.out.println(Customer1.Green + "Account UnBlock Successfully......." + Customer1.Reset);
    ...
    public static void main(String[] args) {
        ...
        while (flag) {
            ...
            switch (choice) {
                case 1:
                    ...
                    if (ad.login(username, password)) {
                        ...
                        while (flag1) {
                            ...
                            System.out.println(Cyan + "\n---------------------------------------\n" + Reset);
                            System.out.println(Magenta + "~~~~~~~~~~~~~~ADMIN MENU~~~~~~~~~~~~~~~\n" + Reset);

                            System.out.println("Enter : 1 for Create Account"
                                    + "\nEnter : 2 for view particular account"
                                    + "\nEnter : 3 for view all account detail"
                            ...
                            switch (choice1) {
                                case 1:
                                    System.out.println(Cyan + "-------------Create Account------------\n" + Reset);
                                    ...
                                    if (age >= 15 && age <= 70) {
                                        ...
                                        while (true) {
                                            if (pan.length() == 10) {
                                                ...
                                                System.out
                                                        .println(Red + "***Pan card must be equal 10 digit***" + Reset);
                                                pan = sc.next();
                                            }
                                        }
                                        ...
                                        while (true) {
                                            ...
                                            File f = new File("C:/Users/rahul/OneDrive/Desktop/DemoBank/Customer");
                                ...
                                case 2:
                                    System.out.println(
                                            Cyan + "-------------Account Detail--------------" + Reset);
                                    ad.viewaccountdetail(sc);
                                    break;
                ...
                case 2:
                    System.out.println(Magenta + "-------------Customer Login-------------\n" + Reset);
                    ...
                    if (obj.login(username1, password1)) {
                        ...
                        while (flag2) {
                            ...
                            System.out.println("\n1. View Account Detail  " + "\t2. Apply for loan");
                            ...
                            switch (choice2) {
                                ...
                                case 2:
                                    System.out.println(Magenta + "-------------Apply For Loan--------------\n" + Reset);
